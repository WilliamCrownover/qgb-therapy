		...
		<>
			<div className='fullContainer'>
				<div className="pageContainer">
					...
					<p style={{ textIndent: '40px' }}>I am currently offering in-person psychotherapy services for adults in the Austin, TX Area, and telehealth services for trans and gender non-conforming adults throughout Texas. My hours are 11am-7pm Monday-Friday.
					</p>
					<h4>Approach</h4>
					...
					<h5>Fees </h5>
					<p style={{ textIndent: '40px' }}>Psychotherapy sessions are $175 per 50-minute hour. Assessments are $500 flat fee. I am an out of network provider. Sliding scale is available for BIPOC and Trans folks.
					</p>
				</div>
				<Footer />
			</div>
