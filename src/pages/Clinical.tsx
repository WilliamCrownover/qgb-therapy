...
export const Clinical = () => {
	...
	return (
		<PageContainer pageTitle='Clinical Services'>
			...
			<TabbedParagraph content={'I am currently offering telehealth psychotherapy services for adults throughout Texas.'}/>
			...
			<h4>Experience</h4>
			<TabbedParagraph content={'During grad school, Dr. Bailey worked at Portia Bell Hume in the partial hospitalization program providing interpersonal process groups to adults with chronic mental health struggles and systemic stressors. As well, he provided long-term outpatient therapy to individuals with personality and dissociative disorders through the Pacific Center for Human Growth, the oldest LGBTQIA+ center in the Bay Area. Dr. Bailey completed his predoctoral internship at The University of Texas at Austin Counseling and Mental Health Center where he specialized in working within the transgender and gender non-conforming community and those experiencing multiplicity or plurality. He then completed a post-doctoral fellowship supervised by Krista Jordan, PhD.'}/>
